...
#define GST_MFX_TYPE_VC1_PARSE \
  (gst_mfx_vc1_parse_get_type())
#define GST_VC1_PARSE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj),GST_MFX_TYPE_VC1_PARSE,GstMfxVC1Parse))
#define GST_VC1_PARSE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass),GST_MFX_TYPE_VC1_PARSE,GstMfxVC1ParseClass))
#define GST_IS_VC1_PARSE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj),GST_MFX_TYPE_VC1_PARSE))
#define GST_IS_VC1_PARSE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass),GST_MFX_TYPE_VC1_PARSE))
...
typedef struct _GstVC1Parse GstMfxVC1Parse;
typedef struct _GstVC1ParseClass GstMfxVC1ParseClass;
...
struct _GstVC1Parse
{
  ...
  /* TRUE if we have already sent the codec-data,
...
GType gst_mfx_vc1_parse_get_type (void);
