...
function(FindX11 libs)
  ...
  set(${X_LIBS} "")
  if(XCBDRI3_FOUND)
      list(APPEND X_LIBS ${XCBDRI3_LIBRARIES})
  ...
  if(XCBPRESENT_FOUND)
      list(APPEND X_LIBS ${XCBPRESENT_LIBRARIES})
  ...
  if(X11_FOUND)
    list(APPEND X_LIBS ${X11_LIBRARIES})
    #set(${libs} ${${libs}} ${X11_LIBRARIES} PARENT_SCOPE)
    include_directories (${X11_INCLUDE_DIRS})
  endif()

  if(X11XCB_FOUND)
    list(APPEND X_LIBS ${X11XCB_LIBRARIES})
    #set(${libs} ${${libs}} ${X11XCB_LIBRARIES} PARENT_SCOPE)
    include_directories (${X11XCB_INCLUDE_DIRS})
    add_definitions(-DHAVE_X11XCB)
  endif()


  if(XKB_FOUND)
    list(APPEND X_LIBS ${XKB_LIBRARIES})
  ...
  if(XRENDER_FOUND)
    list(APPEND X_LIBS ${XRENDER_LIBRARIES})
  ...
  if(XRANDR_FOUND)
    list(APPEND X_LIBS ${XRANDR_LIBRARIES})
    #set(${libs} ${${libs}} ${XRANDR_LIBRARIES} PARENT_SCOPE)
    include_directories (${XRANDR_INCLUDE_DIRS})
    add_definitions(-DHAVE_XRANDR)
  endif()

  set(${libs} ${X_LIBS} PARENT_SCOPE)
endfunction(FindX11)
